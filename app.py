...
CLIENT_ID = "northkor10-api-client"
CLIENT_SECRET = '{"clientId":"northkor10-api-client","clientSecret":"V3yAJNWczNm6fF8vGWigoracqRaMmTr3"}T' # 내부에 따옴표가 있는 문자열일 수 있으므로 겉은 작은따옴표(')로 감싸는 것이 안전합니다.
